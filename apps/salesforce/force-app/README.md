...
2. Optional: check Custom Setting **DocEngine Settings → Use External PDF**, point Named Credential `DocEngine_Pdf` at **https://docengine.pro** (password = API token). Callout is `POST /api/v1/render/pdf`.
